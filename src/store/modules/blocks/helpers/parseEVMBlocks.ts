...
import { Buffer } from '@axia-systems/axiajs/dist'
import { Serialization } from '@axia-systems/axiajs/dist/utils'
...
export function parseEVMBlockTxs(txs: EVMBlockTransaction[] | null) {
    ...
    const parsedTxs = txs.map((tx) => {
        ...
        return {
            ...
            // PAYLOAD
            value: toAXC(parseInt(web3.utils.hexToNumberString(tx.value)), 18),
